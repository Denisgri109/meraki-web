...
const TEXT_GROUPS: TextGroup[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'landing.testimonial.badge', label: 'Beauty Closing Badge', fallback: 'Everything In One Place', placeholder: 'Everything In One Place' },
      { key: 'landing.testimonial.quote', label: 'Beauty Closing Headline', fallback: 'Booking, products and courses — in one place, on one account.', multiline: true, rows: 2, placeholder: 'Booking, products and courses...' },
      { key: 'landing.testimonial.subline', label: 'Beauty Closing Subline', fallback: 'Create an account free — you only pay when you book.', placeholder: 'Create an account free...' },
      ...
      { key: 'landing.pilates.testimonial.badge', label: 'Pilates Closing Badge', fallback: 'Ready When You Are', placeholder: 'Ready When You Are' },
      { key: 'landing.pilates.testimonial.quote', label: 'Pilates Closing Headline', fallback: 'Small classes, qualified instructors, and a plan that fits the body you have today.', multiline: true, rows: 2, placeholder: 'Small classes, qualified instructors...' },
      { key: 'landing.pilates.testimonial.subline', label: 'Pilates Closing Subline', fallback: 'Book a single class first — no membership, no commitment.', placeholder: 'Book a single class first...' },
    ],
  },
  {
    id: 'pages',
