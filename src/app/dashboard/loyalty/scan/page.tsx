...
import {
  ArrowLeft, Loader2, X, Sparkles, Star, RefreshCw, ScanLine,
} from 'lucide-react';
...
export default function LoyaltyScanPage() {
  ...
  }, [isClient, startScanner, stopScanner]);
    ...
    <div className="max-w-2xl mx-auto animate-fade-in">
      ...
      <div className="glass-card p-5">
        ...
        <ul className="space-y-1.5 text-sm text-[var(--color-text-secondary)]">
          <li className="flex gap-2"><span className="text-amber-500">•</span> Scan the master&apos;s <strong>Stamp QR</strong> after each completed appointment to collect a stamp.</li>
